            ...
            <div class="col-md-8">
                ...
                <div class="post-container">
                  ...
                  <?php
                   ...
                   $sql = "SELECT post.post_id, post.titile, post.description,post.post_date,post.post_author,
                    category.category_name,user.username,post.category,post.post_img FROM post
                    LEFT JOIN category ON post.category = category.category_id
                    LEFT JOIN user ON post.post_author = user.user_id
                    WHERE post.titile LIKE '%{$search_term}%' OR post.description LIKE '%{$search_term}%'
                  ...
                  ?>
                    ...
                    $sql1 = "SELECT * FROM post
                            WHERE post.titile LIKE '%{$search_term}%'";
